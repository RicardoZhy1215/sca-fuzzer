...
mov rdx, rbx 
and rax, 0b1111111111111 # instrumentation
mov qword ptr [r14 + rax], 4840 
and rcx, 0b1111111111111 # instrumentation
mov qword ptr [r14 + rcx], 6136 
and rsi, 0b1111111111111 # instrumentation
mov qword ptr [r14 + rsi], 2744 
mov rax, rdx 
and rax, 0b1111111111111 # instrumentation
mov qword ptr [r14 + rax], 3016 
and rax, 0b1111111111111 # instrumentation
